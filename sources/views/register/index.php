            ...
            <form action="/register" method="POST">
                ...
                <div class="input-container">
                    <input type="email" id="email" name="email"
                        ...
                        value="<?= htmlspecialchars($_POST['email'] ?? '', ENT_QUOTES, 'UTF-8') ?>" placeholder="Email"
                        required>
                </div>
                ...
                <div class="input-container">
                    <input type="text" id="lastname" name="lastname"
                        ...
                        value="<?= htmlspecialchars($_POST['lastname'] ?? '', ENT_QUOTES, 'UTF-8') ?>" placeholder="Nom"
                        required>
                </div>
                ...
                <div class="input-container">
                    <input type="text" id="country" name="country"
                        ...
                        value="<?= htmlspecialchars($_POST['country'] ?? '', ENT_QUOTES, 'UTF-8') ?>" placeholder="Pays"
                        required>
                </div>
