...
--
-- Host: mariadb:3306
-- Generation Time: Feb 12, 2025 at 12:11 AM
...
ALTER TABLE `user_groups`
  ...
  ADD KEY `fk_user_groups_group_id` (`group_id`);
...
ALTER TABLE `user_group_permissions`
  ...
  ADD KEY `fk_user_group_permissions_group_id` (`group_id`);
...
--
ALTER TABLE `user_groups`
  ADD CONSTRAINT `fk_user_groups_group_id` FOREIGN KEY (`group_id`) REFERENCES `groups` (`id`) ON DELETE CASCADE,
...
--
ALTER TABLE `user_group_permissions`
  ADD CONSTRAINT `fk_user_group_permissions_group_id` FOREIGN KEY (`group_id`) REFERENCES `groups` (`id`) ON DELETE CASCADE,
